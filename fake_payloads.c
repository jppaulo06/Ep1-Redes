...
const char *FAKE_CONNECTION_START =
...
// 16 * 32 + 4 = 516
const int FAKE_CONNECTION_START_SIZE = 516;

const char *FAKE_CONNECTION_TUNE =
    "\x01\x00\x00\x00\x00\x00\x0c\x00\x0a\x00\x1e\x00\x01\x00\x02\x00"
    "\x00\x00\x3c\xce";

// 16 * 1 + 4 = 20
const int FAKE_CONNECTION_TUNE_SIZE = 20;

const char *FAKE_CONNECTION_OPEN_OK =
    "\x01\x00\x00\x00\x00\x00\x05\x00\x0a\x00\x29\x00\xce";

const int FAKE_CONNECTION_OPEN_OK_SIZE = 13;

const char *FAKE_CHANNEL_OPEN_OK =
    "\x01\x00\x01\x00\x00\x00\x08\x00\x14\x00\x0b\x00\x00\x00\x00\xce";

const int FAKE_CHANNEL_OPEN_OK_SIZE = 16;
