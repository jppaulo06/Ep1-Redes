...
ssize_t Recv_func(int fildes, char *buf, size_t nbyte, int flags,
...
#define Recv(fildes, buf, nbyte, flags)                                        \
  Recv_func(fildes, buf, nbyte, flags, __FILE__, __FUNCTION__, __LINE__)
